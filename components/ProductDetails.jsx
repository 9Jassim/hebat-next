      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
        ...
        <div className="order-2 lg:order-1">
          ...
          <p className="text-gray-700 text-sm mb-4">
            <strong>{t("model")}:</strong> {product.model || "N/A"}
          </p>
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-6 mb-2">{t("manual")}</h2>
          {product.manual ? (
            <a
            ...
            <p className="text-gray-600 text-sm">{t("noManual")}</p>
          )}
        </div>
      </div>
